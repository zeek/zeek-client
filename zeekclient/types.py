...
class NodeStatus(SerializableZeekType):
    ...
    def __init__(self, node, state, mgmt_role, cluster_role, pid=None, port=None, metrics_port=None):
    ...
    def to_brokertype(self):
        ...
        metrics_port = bt.NoneType() if self.metrics_port is None else bt.Port(self.metrics_port)
