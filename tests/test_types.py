...
class TestTypes(unittest.TestCase):
    ...
    def test_instance(self):
        ...
        val1 = self.brokertype_roundtrip(val0)
        self.assertEqual(val0, val1)
        self.assertEqual(val0.to_json_data(),
                         {'name': 'instance1'})
    ...
    def test_node(self):
        ...
        val0 = Node('worker1', 'instance1', ClusterRole.WORKER,
                    State.PENDING, port=1234, scripts=['foo/bar/baz.zeek'],
                    options=[Option('foo', 'bar')], interface='eth0',
                    cpu_affinity=13, env={'FOO': 'BAR'})
        val1 = self.brokertype_roundtrip(val0)
        self.assertEqual(val0, val1)
    ...
    def test_node_status(self):
        ...
        # few types below.
        val0 = NodeStatus('worker1', State.RUNNING, ManagementRole.NONE,
                          ClusterRole.WORKER, pid=123, port=1234)

        val1 = NodeStatus.from_brokertype(bt.Vector([
            bt.String('worker1'),
    ...
    def test_result(self):
        val0 = Result('reqid-1234', success=False, instance='instance1',
                      data=bt.String('data'), error='an error', node='worker1')

        val1 = Result.from_brokertype(bt.Vector([
    ...
    def test_node_outputs(self):
        ...
        val1 = NodeOutputs.from_brokertype(bt.Vector([
